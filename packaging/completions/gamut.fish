...
complete -c gamut      -l primaries   -d 'Override the color primaries'  -x -a 'bt709 p3 bt2020 adobe'
...
complete -c gamut      -l tone-map    -d 'Start with this tone map'       -x -a 'none neutral'
...
complete -c gamut      -l paste       -d 'Paste the image on the clipboard and show it first'
complete -c gamut      -l timing      -d 'Print decode and startup timings to stderr'
