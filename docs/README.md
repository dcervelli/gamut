...
| | |
| --- | --- |
| [Architecture](architecture.md) | The three rendering layers, the display list, and where each file's job is |
| [The interface](interface.md) | Why the controls are shaped as they are: the chrome, the pointer's layer stack, the information panel, menus |
...
| [Tests](testing.md) | What is covered, including the seven that run on a real adapter |
