...
//! there, and a swatch of the colour it comes out as.
//!
...
//! measurement — the count a sensor recorded, the metre a terrain model
//! states — and are the reason anyone points at a pixel; hexadecimal is those
//! same codes written the way the rest of the world writes a colour down. The
//! mapped values are what the window, the exposure and the false colour have
...
//! without asking anyone to read three decimals and imagine a colour.
...
pub enum PixelFormat {
    ...
    /// and no spaces — `E78040` — which is how a colour is written down
    ...
    #[default]
    Decimal,
    /// What the window, the exposure and the false colour have made of them.
    Mapped,
}
...
/// them and nothing in front. `E78040` is what an 8-bit colour comes to, which
/// is what a colour is called everywhere else.
///
...
mod tests {
    ...
    fn each_format_says_what_is_there_in_its_own_terms() {
        ...
        // No prefix and no spaces: what goes in a colour picker.
